...
<body>
 <h1>EXCLUIR VENDA</h1>
    ...
    <form id="section-efetuar-vendas" class="form-row">
        ...
        <div class="col">
            ...
            <select id="parc-vendedor">
                ...
                <option value="parcelado">PARCELADO 2x</option>
                <option value="parcelado">PARCELADO 3x</option>
                <option value="parcelado">PARCELADO 4x</option>
                <option value="parcelado">PARCELADO 5x</option>
            </select>
        </div>
        <div class="col">
    ...
    <section id="section-botoes">
        <button class="botao" id="excluir-venda" onclick="window.location='vendas.html';">EXCLUIR</button>
