	...
	<form action="excProduto" method="post">
		<DIV id="grp_idproduto"
			...
			<DIV id="txt_idproduto" style="position: relative; margin-top: 2px;">
				<INPUT size="12" type="text" maxlenght="20" name="idProduto" value="<%= prodAtual.getIdProduto() %>
					readonly="readonly" />
			</DIV>
		</DIV>
		...
		<DIV id="grp_precocusto"
			...
			<DIV id="txt_precocusto" style="position: relative; margin-top: 2px;">
				<INPUT size="12" type="number" maxlenght="10" name="precoCusto" <%= prodAtual.getPrecoCusto() %>
					readonly="readonly" />
			</DIV>
		</DIV>
		<DIV id="grp_precovenda"
			...
			<DIV id="txt_precovenda" style="position: relative; margin-top: 2px;">
				<INPUT size="12" type="number" maxlenght="10" name="precoVenda" <%= prodAtual.getPrecoVenda() %>
					readonly="readonly" />
			</DIV>
		</DIV>
		<DIV id="grp_quantidade"
			...
			<DIV id="txt_quantidade" style="position: relative; margin-top: 2px;">
				<INPUT size="12" type="number" maxlenght="20" name="quantidade" <%= prodAtual.getQuantidade() %>
					readonly="readonly" />
			</DIV>
		</DIV>
		<DIV id="grp_botoes" style="position: relative; margin-top: 20px;">
			...
			<DIV id="btn_cancelar"
				style="position: relative; margin-left: 50px; display: inline-block;">
				<FORM>
					<button onClick='location.href="acessoListarProdutos"'>Voltar</button>
				</FORM>
			</DIV>
		</DIV>
	</DIV>
